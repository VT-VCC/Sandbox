    ...
    #define TX_RATE       2000 //number of milliseconds between TX window
    #define TX_OFFSET     200  //Absolute Value of random TX Rate offset
    ...
    void loop() {
      ...
      if (radio.receiveDone()) {//Packet is received by radio
        ...
        Serial.print("RX Message: "); //Serial.println(msg);
        ...
        memcpy(tx_msg+33, &DST, 1);
        memcpy(tx_msg+34, &FLAG, 1);
        
        Serial.print("TX Message: "); //Serial.println(msg);
