...
bool RFM69::initialize(uint8_t freqBand, uint8_t nodeID, uint8_t networkID)
{
  const uint8_t CONFIG[][2] =
  {
    ...
    ///* 0x02 */ { REG_DATAMODUL, RF_DATAMODUL_DATAMODE_PACKET | RF_DATAMODUL_MODULATIONTYPE_FSK | RF_DATAMODUL_MODULATIONSHAPING_00 }, // no shaping <--ORIGINAL
    /* 0x02 */ { REG_DATAMODUL, RF_DATAMODUL_DATAMODE_PACKET | RF_DATAMODUL_MODULATIONTYPE_FSK | RF_DATAMODUL_MODULATIONSHAPING_10 }, // GMSK, BT=0.5

    ///* 0x03 */ { REG_BITRATEMSB, RF_BITRATEMSB_55555}, // default: 4.8 KBPS <---Original
    ///* 0x04 */ { REG_BITRATELSB, RF_BITRATELSB_55555}, //<---Original
    /* 0x03 */ { REG_BITRATEMSB, RF_BITRATEMSB_9600}, // Bit Rate:  9.6 KBPS
    /* 0x04 */ { REG_BITRATELSB, RF_BITRATELSB_9600},

    ///* 0x05 */ { REG_FDEVMSB, RF_FDEVMSB_50000}, // default: 5KHz, (FDEV + BitRate / 2 <= 500KHz)  <---Original
    ///* 0x06 */ { REG_FDEVLSB, RF_FDEVLSB_50000},  //<---Original
    ...
    ///* 0x38 */ { REG_PAYLOADLENGTH, 66 }, // in variable length mode: the max frame size, not used in TX <----ORIGINAL
...
void RFM69::interruptHandler() {
  ...
  if (_mode == RF69_MODE_RX && (readReg(REG_IRQFLAGS2) & RF_IRQFLAGS2_PAYLOADREADY))
  {
    ...
    //PAYLOADLEN = PAYLOADLEN > 66 ? 66 : PAYLOADLEN; // precaution<--Original
